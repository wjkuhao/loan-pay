    ...
    */
    ...
    public void pay(OrderPayMessage payMessage) {
        ...
        try {
            ...
            if (null == merchant || StringUtils.isBlank(merchant.getJinyuntongMerchantId()) || StringUtils.isBlank(merchant.getJinyuntongPrivateKey()) || StringUtils.isBlank(merchant.getJinyuntongPublicKey())) {
    ...
    */
    ...
    public void payQuery(OrderPayQueryMessage payQueryMessage) {
        try {
            ...
            if (null == merchant || StringUtils.isBlank(merchant.getJinyuntongMerchantId()) || StringUtils.isBlank(merchant.getJinyuntongPublicKey()) || StringUtils.isBlank(merchant.getJinyuntongPrivateKey())) {
